...
class LocalStorage {
  ...
  Future<int> getInt(String key) async {
    if (_cache.containsKey(key)) {
      ...
      _log.debug(
          'Get int from cache.', <String, dynamic>{'key': key, 'value': value});
      return value;
    }
    ...
    if (sharedPreferences.containsKey(key)) {
      ...
      _cache[key] = value;
      _log.debug('Get int from shared preferences.',
  ...
  Future<String> getString(String key) async {
    if (_cache.containsKey(key)) {
      ...
      _log.debug('Get string from cache.',
          <String, dynamic>{'key': key, 'value': value});
      return value;
    }
    ...
    if (sharedPreferences.containsKey(key)) {
      ...
      _cache[key] = value;
      _log.debug('Get string from shared preferences.',
          <String, dynamic>{'key': key, 'value': value});
      return value;
    }
    return null;
